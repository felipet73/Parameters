...
namespace S10Cuantificacion.Data
{
    class Utils
    {
        ...
        Display(ListView lvCur, Collectors.Collector snoopCollector)
        {
            ...
            MessageBox.Show(snoopCollector.Data().Count.ToString(), "");
            for (int i = 0; i < snoopCollector.Data().Count; i++)
            {
                Data tmpSnoopData = (Data)snoopCollector.Data()[i];
       ...
       CopyToClipboard(ListView lv)
        {
            ...
            System.String headerFormat = System.String.Format("{{0,{0}}}----{1}\r\n", maxField, new System.String('-', maxValue));
            System.String tabbedFormat = System.String.Format("{{0,{0}}}    {{1}}\r\n", maxField);
            ...
            System.String txt = bldr.ToString();
            if (System.String.IsNullOrEmpty(txt) == false)
            {
        ...
        public static Int32
        Print(System.String title, ListView lv, System.Drawing.Printing.PrintPageEventArgs e, Int32 maxFieldWidth, Int32 maxValueWidth, Int32 currentItem)
        {
        ...
        GetPrintDocumentName(TreeNode node)
        {
            ...
            if (str != null)
            {
                //return System.IO.Path.GetFileNameWithoutExtension(root.Tag as System.String);
            }
